// $ANTLR 2.7.7 (20060906): "NotifyCondition.g" -> "NotifyConditionLexer.java"$
...
public class NotifyConditionLexer extends antlr.CharScanner implements NotifyConditionLexerTokenTypes, TokenStream
 {
...
public NotifyConditionLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("state.change", this), new Integer(19));
	literals.put(new ANTLRHashString("changed.by.me", this), new Integer(18));
	literals.put(new ANTLRHashString("true", this), new Integer(12));
	literals.put(new ANTLRHashString("and", this), new Integer(10));
	literals.put(new ANTLRHashString("failure", this), new Integer(15));
	literals.put(new ANTLRHashString("changed", this), new Integer(17));
	literals.put(new ANTLRHashString("success", this), new Integer(14));
	literals.put(new ANTLRHashString("false", this), new Integer(13));
	literals.put(new ANTLRHashString("not", this), new Integer(11));
	literals.put(new ANTLRHashString("error", this), new Integer(16));
}
