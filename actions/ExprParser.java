...
public class ExprParser extends Parser {
	...
	public static class EnclosedeContext extends EContext {
		public EContext e;
		public EContext e() {
			return getRuleContext(EContext.class,0);
		}
		public EnclosedeContext(EContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).enterEnclosede(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).exitEnclosede(this);
		}
	}
	...
	private EContext e(int _p) throws RecognitionException {
		...
		try {
			...
			case INT:
				...
				((IntContext)_localctx).v =  (((IntContext)_localctx).INT!=null?Integer.valueOf(((IntContext)_localctx).INT.getText()):0);
				}
				break;
			case ID:
				{
				...
				((IdContext)_localctx).ID = match(ID);
				      ...
				      String id = (((IdContext)_localctx).ID!=null?((IdContext)_localctx).ID.getText():null);
				      ((IdContext)_localctx).v =  memory.containsKey(id) ? memory.get(id) : 0;
				      
				}
				break;
			case T__1:
				{
				_localctx = new EnclosedeContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(22);
				match(T__1);
				setState(23);
				((EnclosedeContext)_localctx).e = e(0);
				setState(24);
				match(T__2);
				((EnclosedeContext)_localctx).v =  ((EnclosedeContext)_localctx).e.v;
				}
				break;
			default:
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(31);
						((MultdivContext)_localctx).b = ((MultdivContext)_localctx).e = e(6);
						((MultdivContext)_localctx).v =  eval(((MultdivContext)_localctx).a.v, (((MultdivContext)_localctx).op!=null?((MultdivContext)_localctx).op.getType():0), ((MultdivContext)_localctx).b.v);
						}
						break;
					case 2:
						{
						_localctx = new AddsubContext(new EContext(_parentctx, _parentState));
						((AddsubContext)_localctx).a = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_e);
						setState(34);
						...
						setState(36);
						((AddsubContext)_localctx).b = ((AddsubContext)_localctx).e = e(5);
						((AddsubContext)_localctx).v =  eval(((AddsubContext)_localctx).a.v, (((AddsubContext)_localctx).op!=null?((AddsubContext)_localctx).op.getType():0), ((AddsubContext)_localctx).b.v);
						}
						break;
					}
					} 
